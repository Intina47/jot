...
- Tag releases as `v1.5.3` and push the tag.
- The release workflow builds artifacts on tag push.
- If GitHub Actions is unavailable, use `.\scripts\release-local.ps1 -Version 1.5.3`.
...
```powershell
.\scripts\release-local.ps1 -Version 1.5.3
```

What it does:

- Builds the four release artifacts into `dist/`
- Creates or updates the GitHub release for `v1.5.3`
...
```powershell
$url = "https://github.com/Intina47/jot/releases/download/v1.5.3/jot_v1.5.3_windows_amd64.zip"
$checksum = "..."
